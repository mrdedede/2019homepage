<div style="text-align:center; position: relative; top:10px;">
    <canvas id="ttc" width="300" height="300">
</div>
<br>
...
<script>
    ...
    function onDown(event){
        cx = event.pageX - (scr.offsetLeft + 8);
        cy = event.pageY - (scr.offsetTop + menu.offsetHeight + 18);
        px = transform(cx);
        py = transform(cy);
...
<h1>Tic Tac Toe!</h1>
<button id="restart" onclick="restart()" style="visibility: hidden;">Restart</button>
</div>